...
function handleLenderMatchSubmission(req, res) { //eslint-disable-line complexity
  ...
  if (_.isEmpty(errors)) {
    createLenderMatchRegistration({
      ...
      businessWebsite: ((req.body.hasOwnProperty("businessInfoData") && req.body.businessInfoData.hasOwnProperty("businessWebsite")) ? req.body.businessInfoData.businessWebsite : ""),
      businessDescription: ((req.body.hasOwnProperty("businessInfoData") && req.body.businessInfoData.hasOwnProperty("businessDescription")) ? req.body.businessInfoData.businessDescription : ""),
