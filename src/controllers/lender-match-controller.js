...
function handleLenderMatchSubmission(req, res) { //eslint-disable-line complexity
  ...
  if (_.isEmpty(errors)) {
    createLenderMatchRegistration({
      ...
      loanUsage: ((req.body.hasOwnProperty("loanData") && req.body.loanData.hasOwnProperty("loanUsage")) ? req.body.loanData.loanUsage : ""),
      businessWebsite: ((req.body.hasOwnProperty("businessInfoData") && req.body.businessInfoData.hasOwnProperty("businessInfoWebsite")) ? req.body.businessInfoData.businessInfoWebsite : ""),
      businessDescription: ((req.body.hasOwnProperty("businessInfoData") && req.body.businessInfoData.hasOwnProperty("businessInfoDescription")) ? req.body.businessInfoData.businessInfoDescription : ""),
      hasWrittenPlan: ((req.body.hasOwnProperty("additionalInfoData") && req.body.additionalInfoData.hasOwnProperty("hasWrittenPlan")) ? req.body.additionalInfoData.hasWrittenPlan : false),
      hasFinancialProjections: ((req.body.hasOwnProperty("additionalInfoData") && req.body.additionalInfoData.hasOwnProperty("hasFinancialProjections")) ? req.body.additionalInfoData.hasFinancialProjections : false),
      isGeneratingRevenue: ((req.body.hasOwnProperty("additionalInfoData") && req.body.additionalInfoData.hasOwnProperty("isGeneratingRevenue")) ? req.body.additionalInfoData.isGeneratingRevenue : false),
      isVeteran: ((req.body.hasOwnProperty("additionalInfoData") && req.body.additionalInfoData.hasOwnProperty("isVeteran")) ? req.body.additionalInfoData.isVeteran : false)
    })
      .then(function() {
