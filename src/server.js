...
app.use(function(req, res, next) {
  ...
  const requestPathWithoutTraillingSlack = requestPath !== '/' ? _.trimEnd(requestPath, '/') : requestPath
  console.log("requestPathWithoutTraillingSlack",requestPathWithoutTraillingSlack)
