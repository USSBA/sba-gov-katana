...
function sendPasswordUpdateToOca(userName, password, newPassword) {
  ...
  return getEndPointUrl(config.get('oca.soap.wsdlUrl')).then(function(endpoint) {
...
function sendPasswordUpdateRequest() {
  return getCredentials()
    .then(credentials => {
      ...
      return sendPasswordUpdateToOca(credentials.username, credentials.password, newPlainTextPassword).then(
        result => {
