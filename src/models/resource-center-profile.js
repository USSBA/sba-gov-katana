...
var resourceCenterProfile = nonDrupal.define("resourceCenterProfile", {
  id: {
    type: Sequelize.UUID,
    primaryKey: true
  },
...
var resourceCenterLanguages = nonDrupal.define("resourceCenterLanguages", {
  language: {
    type: Sequelize.STRING,
    allowNull: false
  }
...
var resourceCenterHours = nonDrupal.define("resourceCenterHours", {
  mondayOpen: {
    type: Sequelize.STRING
  },
  mondayClose: {
...
var resourceCenterServices = nonDrupal.define("resourceCenterServices", {
  service: {
    type: Sequelize.STRING,
    allowNull: false
  }
...
var resourceCenterExpertise = nonDrupal.define("resourceCenterExpertise", {
  expertise: {
    type: Sequelize.STRING,
    allowNull: false
  }
