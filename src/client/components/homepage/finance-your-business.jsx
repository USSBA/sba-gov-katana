...
export const FinanceYourBusinessSection = (props) => <div className={ styles.fybContainer }>
                                                       ...
                                                       <div className={ styles.fybAccentBox }>
                                                         <ul>
                                                           <a href="https://www.sba.gov/loans-grants/see-what-sba-offers/what-sba-offers-help-small-businesses-grow">
                                                             <li className={ styles.borderBox }>What SBA offers</li>
                                                           </a>
                                                           <a href="https://www.sba.gov/loans-grants/see-what-sba-offers/sba-loan-programs">
                                                             <li className={ styles.borderBox }>Loan programs</li>
                                                           </a>
                                                           <a href="https://www.sba.gov/tools/linc">
