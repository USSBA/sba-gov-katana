...
let Main = props => (
  <Async componentProps={props} load={import('./templates/main.jsx')} />
)
let LenderMatchMain = props => (
  <Async
    componentProps={props}
    load={import('./templates/lender-match/lender-match-main.jsx')}
  />
)
...
let StyleGuide = props => (
  <Async
    componentProps={props}
    load={import('./templates/style-guide/style-guide.jsx')}
  />
)
...
let LandingPage = props => (
  <Async
    componentProps={props}
    load={import('./templates/lender-match/landing-page.jsx')}
  />
)
let SuccessPage = props => (
  <Async
    componentProps={props}
    load={import('./templates/lender-match/success-page.jsx')}
  />
)
...
let LoanForm = props => (
  <Async
    componentProps={props}
    load={import('./templates/lender-match/loan-form.jsx')}
  />
)
let ContactInfo = props => (
  <Async
    componentProps={props}
    load={import('./organisms/lender-match/form/contact-info.jsx')}
  />
)
let LoanInfo = props => (
  <Async
    componentProps={props}
    load={import('./organisms/lender-match/form/loan-info.jsx')}
  />
)
let BusinessInfo = props => (
  <Async
    componentProps={props}
    load={import('./organisms/lender-match/form/business-info.jsx')}
  />
)
let IndustryInfo = props => (
  <Async
    componentProps={props}
    load={import('./organisms/lender-match/form/industry-info.jsx')}
  />
)
let AdditionalInfo = props => (
  <Async
    componentProps={props}
    load={import('./organisms/lender-match/form/additional-info.jsx')}
  />
)
let ReviewSubmitInfo = props => (
  <Async
    componentProps={props}
    load={import('./organisms/lender-match/form/review-submit-info.jsx')}
  />
)
let DeveloperTester = props => (
  <Async
    componentProps={props}
    load={import('./organisms/developer-tester/developer-tester.jsx')}
  />
)
let TenStepsLandingPage = props => (
  <Async
    componentProps={props}
    load={import('./templates/ten-steps-page/ten-steps-landing-page.jsx')}
  />
)
let HomepageContainer = props => (
  <Async
    componentProps={props}
    load={import('./templates/homepage/homepage-container.jsx')}
  />
)
let SamplePage = props => (
  <Async componentProps={props} load={import('./pages/sample.jsx')} />
)
let RootPage = props => (
  <Async componentProps={props} load={import('./pages/root-page.jsx')} />
)
let DocumentLookupPage = props => (
  <Async
    componentProps={props}
    load={import('./pages/document-lookup-page/document-lookup-page.jsx')}
  />
)
let ArticleLookupPage = props => (
  <Async
    componentProps={props}
    load={import('./pages/article-lookup-page/article-lookup-page.jsx')}
  />
)
...
const mainRoutes = [
  ...
  <Redirect
    key={27}
    from="/funding-programs/loans/lendermatch"
    to="/lendermatch"
  />,
  ...
  <Route
    key={12}
    path={constants.routes.tenSteps}
