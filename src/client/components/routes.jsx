...
let EventsPage = props => (
  <Async componentProps={props} load={import('./pages/events-page/events-page.jsx')} />
)
...
const mainRoutes = [
  ...
  <Route key={56} path="/events/find/" component={EventsPage} />,
  <Redirect key={57} from="/events/find" to="/events/find/" />,
