...
class Page extends React.Component {
  ...
  render() {
    ...
    if (this.props.data && this.props.lineage) {
      if (section === "business-guide" || this.props.data.type === "page") {
      ...
      } else if (section === "funding-programs" || this.props.data.type === "programPage") {
        let heroData;
        if (this.props.data) {
          heroData = {
        ...
        return (<ProgramPage lineage={this.props.lineage[0][0]} heroData={heroData} title={this.props.data.title} paragraphs={this.props.data.paragraphs} lineage={this.props.lineage}/>);
      }
    }
    return (<div/>);
  }
