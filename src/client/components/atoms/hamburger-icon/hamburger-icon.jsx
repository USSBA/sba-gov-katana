...
class HamburgerIcon extends React.Component {
  ...
  getClosed() {
    return (
      <div className={styles.menuIconContainer}>
        <svg
          className={styles.menuIconHamburger}
          width="15px"
          height="13px"
          viewBox="0 0 15 13"
        >
          ...
          >
            ...
            >
              <g
                id="Rectangle-14-+-whitepaper-Copy-11"
                transform="translate(274.000000, 116.000000)"
              >
                <path
  ...
  getText(open) {
    return (
      <div className={open ? styles.textOpen : styles.textClosed}>
        {open ? 'Close' : 'Menu'}
      </div>
    )
  }
