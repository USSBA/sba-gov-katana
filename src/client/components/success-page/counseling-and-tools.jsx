    ...
    const counselorBox = Object.keys(counselorsData).map((key, index) => {
      ...
      return(
        <div className={styles.counselorBox}>
          <p className={styles.counselorTitle}>{this.trimStr(counselor['title']) || "Not Available"}</p>
          <p className={styles.counselorAttr}>{counselor['name'] || "Not Available"}</p>
          <p className={styles.counselorAttr}>{counselor['street'] + ", " + counselor['additional'] || "Not Available"}</p>
          <p className={styles.counselorAttr}>{counselor['city'] + ", " + counselor['province'] + " " + counselor['postal_code']}</p>
          <p className={styles.counselorAttr}>{this.getMiles(counselor['location_distance']) + " miles away"}</p>
          <p className={styles.counselorAttr}>{'Phone: ' + counselor['phone'] || "Not Available"}</p>
        </div>
      )
    });
    return counselorBox
