...
class BusinessInfoForm extends React.Component {
  ...
  validateSingleField(validationFunction, name, defaultWhenNotSuccessful) {
    ...
    if (
      !includes(BusinessInfoForm.requiredFields, name) &&
  ...
  handleSubmit(e) {
    e.preventDefault()
    this.props.actions.createBusinessInfo(
      pick(this.state, [
        'businessInfoName',
        'businessInfoZipcode',
        'businessInfoDescription',
      ...
      <div>
        <form id={id} ref={input => (this.businessInfoForm = input)} onSubmit={e => this.handleSubmit(e)}>
          <TextInput
            ...
            value={this.state.businessInfoName}
            validationState={this.state.validStates['businessInfoName']}
            autoFocus
          ...
          <TextInput
            ...
            validationState={this.state.validStates['businessInfoZipcode']}
            maxLength="5"
            onBlur={this.handleBlur.bind(this)}
            errorText={constants.messages.validation.invalidZip}
            onFocus={this.handleFocus.bind(this)}
          />
          <TextInput
            id={id + '-website'}
            ...
            onChange={this.handleChange.bind(this)}
            value={this.state.businessInfoWebsite}
            validationState={this.state.validStates['businessInfoWebsite']}
          ...
          <TextArea
            ...
            onChange={this.handleChange.bind(this)}
            value={this.state.businessInfoDescription}
