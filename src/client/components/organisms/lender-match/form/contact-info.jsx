...
class ContactInfoForm extends React.Component {
  ...
  handleSubmit(e) {
    e.preventDefault()
    this.props.actions.createContactInfo({
    ...
    return (
      <div>
        ...
        >
          ...
          <TextInput
            id={id + '-phone'}
            errorText={constants.messages.validation.invalidPhoneNumber}
            label="What is your phone number?"
            name="contactPhoneNumber"
            onChange={this.handleChange.bind(this)}
            value={this.state.contactPhoneNumber}
            validationState={this.state.validStates.contactPhoneNumber}
            onBlur={this.handleBlur.bind(this)}
            onFocus={this.handleFocus.bind(this)}
          />
          <TextInput
            id={id + '-email'}
            errorText={constants.messages.validation.invalidEmail}
            label="What is your email address?"
            name="contactEmailAddress"
            onChange={this.handleChange.bind(this)}
            value={this.state.contactEmailAddress}
            validationState={this.state.validStates.contactEmailAddress}
            onBlur={this.handleBlur.bind(this)}
            onFocus={this.handleFocus.bind(this)}
          />{' '}
          ...
          <TextInput
            id={id + '-email-check'}
            hidden={true}
            label="What is your second email address?"
