...
export class AdditionalInfoForm extends React.Component {
  ...
  handleSubmit(e) {
    ...
    this.props.locationActions.locationChange('/lendermatch/form/review', {
      action: 'Continue Button Pushed',
      label: '/lendermatch/form/review'
    })
      ...
      <div>
        <form id={id} ref={input => (this.addInfoForm = input)} onSubmit={e => this.handleSubmit(e)}>
          ...
          <CheckBox
            ...
            autoFocus={true}
            name="hasWrittenPlan"
            label="I have written a business plan"
            handleChange={this.handleClick.bind(this)}
            checked={this.state.additionalInfoFields.hasWrittenPlan}
          />
          <CheckBox
            id={id + '-projections'}
            name="hasFinancialProjections"
            label="I have financial projections"
            handleChange={this.handleClick.bind(this)}
            checked={this.state.additionalInfoFields.hasFinancialProjections}
          />
          <CheckBox
            id={id + '-revenue'}
            name="isGeneratingRevenue"
            label="I'm generating revenue"
            handleChange={this.handleClick.bind(this)}
            checked={this.state.additionalInfoFields.isGeneratingRevenue}
          />
          <FormPageButtons
            parentId={id}
