      ...
      <div id={this.props.tellMeHowAnchor} className={styles.section}>
        ...
        <div className={styles.checklist}>
          <ToDo
            icon={planIcon}
            title="Business plan"
            caption="Most lenders expect a business plan when you apply for startup funding. If you need to create one, follow our free business plan guide."
          />
          <ToDo
            icon={fundsIcon}
            title="Amount & use of funds"
            caption="Know how much capital you need and how it will help your business. You can’t use an SBA-approved loan to flip a house."
          />
          <ToDo
            icon={creditIcon}
            title="Credit history"
            caption="Lenders use credit scores to determine credit risk and interest rates. The SBA helps guarantee some loans that otherwise may not qualify."
          />
          <ToDo
            icon={projectionsIcon}
            title="Financial projections"
            caption="Show you understand your business' finances, how the funds will be used, and how you'll pay back the loan."
          />
          <ToDo
            icon={collateralIcon}
            title="Collateral"
            caption="Many lenders require you to use another asset to guarantee your loan. This can be a home, car, inventory, or other property you own."
          />
          <ToDo
            icon={industryIcon}
