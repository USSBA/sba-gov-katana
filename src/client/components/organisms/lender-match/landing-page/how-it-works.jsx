...
import howItWorksImg1 from "assets/images/lender-match/howItWorksImg1.jpg";
import howItWorksImg2 from "assets/images/lender-match/howItWorksImg2.jpg";
import howItWorksImg3 from "assets/images/lender-match/howItWorksImg3.jpg";
import howItWorksImg4 from "assets/images/lender-match/howItWorksImg4.jpg";
...
export const HowItWorksSection = (props) => <div className={ styles.section }>
                                              ...
                                              <div className={ styles.step }>
                                                ...
                                                <p className={styles.blurb}>Answer a few questions about your business in as little as five minutes.</p>
                                              </div>
                                              <div className={ styles.step }>
                                              ...
                                              <div className={ styles.step }>
                                                ...
                                                <hr className={styles.line}/>
                                                <p className={styles.blurb}>Submit loan applications and paperwork. You're well on your way to securing a business loan!</p>
                                              </div>
                                            </div>
