...
class ConfirmSection extends React.Component {
  ...
  render() {
    let resendLink = this.state.resendClicked ? (
      <span className={styles.resendLink}>Email was re-sent.</span>
    ) : (
      <a lassName={styles.resendLink} onClick={this.handleClick.bind(this)} href="">
    ...
    return (
      <div className={styles.section}>
        ...
        <h5>
          We sent an email to {this.props.email}.<br />
        ...
        <div className={styles.resources}>
          <Resource
            ...
            description="Many lenders expect a business plan — consider using this template."
            buttonURL="/tools/business-plan/1"
            buttonText="Create Plan"
          />
          <Resource
            title="How to prep a loan proposal"
            duration="30-minute video"
            description="This video learning course will walk you through commonly requested documents."
            buttonURL="/tools/sba-learning-center/training/how-prepare-loan-package"
            buttonText="Watch Video"
          />
          <Resource
            title="5 Tips for loan applications"
            duration="5-minute read"
            description="This blog features tips and tricks on getting through the loan process quickly and easily."
            buttonURL="/blogs/5-tips-successfully-navigating-sba-loan-application-process"
