  ...
  render() {
    return (
      <div className={styles.section + ' ' + styles.emailConfirmationText}>
        ...
        <h5>
          Your submission is being forwarded to lenders in your area. Please allow at least two business
          days to be matched with a lender in our network. We'll email you with any updates.
        </h5>
      </div>
    )
  }
