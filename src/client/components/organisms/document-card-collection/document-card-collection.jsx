  ...
  renderCard(item, index) {
    return (
      <div className={"card-container " + styles.card} key={index}>
        <DocumentCard type={this.props.type} data={item} showDetails={this.props.showDetails} showBorder={false} fieldsToShowInDetails={this.props.fieldsToShowInDetails}/>
      </div>
    );
  }
