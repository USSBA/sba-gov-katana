...
import styles from './learning-center-course-lookup.scss'
...
export class LearningCenterCourseLookup extends React.PureComponent {
  renderMultiSelects() {
...
export default LearningCenterCourseLookup
