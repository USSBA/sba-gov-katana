...
class MenuTile extends React.Component {
  ...
  render() {
    let smallTitleComponent = this.props.smallTitle
      ? (
        <h4 className={sharedStyles.smallTitle + " " + (this.props.uppercaseFirstWord
          ? s.upperCase
          : "")}>{this.props.smallTitle}</h4>
      )
      : undefined;
    let tileClass = s.tileNormal + " " + (this.props.inverse
      ? s.tileInverse
      : "");
    let titleContainerClass = s.titleContainer + " " + (this.props.inverse
      ? s.titleInverse
      : "");
    let largeTitleClass = sharedStyles.largeTitle + " " + (this.props.uppercaseFirstWord
      ? s.upperCase
      : "");
    let lineClass = s.line + " " + (this.props.inverse
      ? s.lineInverse
      : "");
    let blurbClass = s.blurb + " " + (this.props.inverse
      ? s.blurbInverse
      : "");
    let iconSource = this.props.inverse
    ...
    return (
      <div id={this.props.id} className={tileClass}>
        ...
        <p id={this.props.id + "-blurb"} className={blurbClass}>{this.props.description}</p>
