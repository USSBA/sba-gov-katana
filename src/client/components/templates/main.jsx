  ...
  render() {
    return (
      <div>
        ...
        <Header theme="sba-blue" disasterAlertIsVisible={this.state.disasterAlertIsVisible} userHasScrolledPastAlert={this.state.userHasScrolledPastAlert}/> {this.props.children}
        <Footer/>
        <ModalController/>
      </div>
    )
