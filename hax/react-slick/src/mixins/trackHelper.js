...
export var getTrackLeft = function (spec) {
  ...
  if (spec.infinite) {
    if (spec.slideCount >= spec.slidesToShow) {
      var centerPaddingAdj = 0;
      if(spec.centerMode && spec.centerPadding && spec.centerPadding.indexOf("%") !== -1){
        centerPaddingAdj = parseFloat(spec.centerPadding) / 100.0 * spec.listWidth * 3;
      }
      slideOffset = (spec.slideWidth - centerPaddingAdj)* spec.slidesToShow * -1;
