...
describe('Person page', () => {
  test('renders correctly', () => {
    const component = renderer.create(<Person personData={firstPersonProps} />)
    const tree = component.toJSON()
    expect(tree).toMatchSnapshot()
  })

  test('heading renders correct text', () => {
    const component = shallow(<Person personData={firstPersonProps} />)
  ...
  test('Subcomponent, ContactCard, renders correctly', () => {
    const component = shallow(<Person personData={secondPersonProps} />)
