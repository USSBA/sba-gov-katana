...
test("BasicPage renders default data", () => {
...
test("BasicPage creates a TitleSection component with appropriate props", () => {
  const component = shallow(
...
test("BasicPage creates a Breadcrumb component with appropriate props", () => {
  const component = shallow(
...
test("BasicPage creates an empty breadcrumb div without a lineage", () => {
  const component = shallow(
    <BasicPage title={title} summary={summary}/>
  );
