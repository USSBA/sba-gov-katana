...
describe('linc soap request test', function() {
  ...
  describe('response handling tests', function() {
    ...
    it('should result in saving a lenderMatchSoapResponse to the database when responseCode is F', function(done) {
      ...
      handleSoapResponse(fakeFailureResponse).then(() => {
    ...
    it('should result in saving a lenderMatchSoapResponse to the database when responseCode is P', function(done) {
      ...
      handleSoapResponse(fakePendingResponse).then(() => {
    ...
    it.skip('should result in an exception if passed an unknown responseCode', function() {
      ...
      handleSoapResponse(fakeUpdateResponse).should.throw(Error, "Unknown Response Code receieved from OCA: unknown");
    });
