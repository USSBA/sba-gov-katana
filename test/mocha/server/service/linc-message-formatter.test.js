...
describe('LINC Message Formatter', function() {
  ...
  describe('Soap Request Formatting', function() {
    ...
    it('should trim a string of length greater than 255', function() {
      let req =
        'We build shopping malls in all states for several years and we ' +
        'have no problem being able to pay back this loan. We have several hundred employees in our Baltimore office. ' +
        "Please give us this loan as we need it so we don't go bankrupt. " +
      ...
      retVal.should.equal(
        "We build shopping malls in all states for several years and we have no problem being able to pay back this loan. We have several hundred employees in our Baltimore office. Please give us this loan as we need it so we don't go bankrupt. We will forever be "
      )
    })
